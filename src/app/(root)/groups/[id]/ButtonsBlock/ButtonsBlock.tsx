...
import { navigateToChat, navigateToGroupChat } from "../../helpers";
...
const ButtonsBlock: React.FC<ButtonsType> = ({groupId, setShowCreatePost, showCreatePost, showCreateEvent, setShowCreateEvent }) => {
  ...
  return (
    <div className={styles.btnsBlock}>
      ...
      <button className={selectedButton} onClick={joinGroupChatHandler}  >Group chat</button>
